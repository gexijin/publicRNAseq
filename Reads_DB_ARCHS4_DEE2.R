################################################################################
# Processing read counts meta data from ARCHRS4 and DEE2
...
#
#     GSEinfo
# [1] "GSEID"   "Species" "Samples" "Title" "Summary"
################################################################################
...
sample_infoM <- cbind(GSMs, tissue, sample_title, sample_series_id, species) # combine mouse sample info
H5close()
...
#################################################
# combines GSEinfo for Dee2 and ARCHRS4 
#################################################
...
# Get get GSE ids from GEOmetadb.sqlite 
################################################################################################
...
# t=dbGetQuery(convert, "Select gsm from sampleInfo")
# count(t)
# 
